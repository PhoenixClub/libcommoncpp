...
enum FileType { TypeFile, TypeDir, TypeSymLink, TypePipe, TypeDevice,
                TypeOther, TypeUnknown };

enum FileOpenMode { FileOpenElseCreate, FileOpen, FileCreate, FileTruncate,
...
class COMMONCPP_API File : public Stream
{
  ...
  static bool makeDirectory(
    ...
    const Permissions &perm = Permissions::defaultDirPerms) throw();
