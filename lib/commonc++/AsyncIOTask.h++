...
class COMMONCPP_API AsyncIOTask
{
  ...
  void _collectResult() throw(IOException, InterruptedException);

  inline void setPending(bool pending)
  { _pending = pending; }

  inline FileHandle getFileHandle() throw()
  { return(_file); }

#ifdef CCXX_OS_WINDOWS
  inline LPOVERLAPPED getControlBlock() throw()
  { return(&_overlapped); }
#else
  inline struct aiocb *getControlBlock() throw()
  { return (&_aiocb); }
#endif
