...
template <typename T> class ObjectPool
{
   ...
   */
  virtual T *reserve() throw(ObjectPoolException) = 0;
   ...
   */
  virtual void release(T *elem) throw(ObjectPoolException) = 0;
  ...
  inline uint_t getAvailable() const throw()
  { return(_avail); }
