...
class COMMONCPP_API RegExp
{
   ...
   * otherwise.
   */
  bool match(const char *text, RegExpMatch matches[], int numMatches) const
    throw();
   ...
   * otherwise.
   */
  bool match(const String &text, RegExpMatch matches[], int numMatches)
    const throw();
