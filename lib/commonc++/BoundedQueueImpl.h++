...
template<typename T> void BoundedQueue<T>::shutdown() throw()
{
...
template<typename T> T BoundedQueue<T>::take() throw(InterruptedException)
{
  ScopedLock lock(_mutex);
...
template<typename T> uint_t BoundedQueue<T>::getSize() const throw()
{
  ScopedLock lock(_mutex);
...
template<typename T> void BoundedQueue<T>::interrupt() throw()
{
  ScopedLock lock(_mutex);
