...
class COMMONCPP_API IntervalTimer
{
  ...
  inline uint_t getInitialDelay() const throw()
  { return(_initialDelay); }

  /** Set the initial delay, in milliseconds. The new value will take
   * effect the next time the timer is started.
   */
  inline void setInitialDelay(uint_t initialDelay) throw()
  { _initialDelay = initialDelay; }

  /** Get the interval, in milliseconds. */
  inline uint_t getInterval() const throw()
  { return(_interval); }

  /** Set the interval, in milliseconds. The new value will take
   * effect the next time the timer is started.
   */
  inline void setInterval(uint_t interval) throw()
  { _interval = interval; }
