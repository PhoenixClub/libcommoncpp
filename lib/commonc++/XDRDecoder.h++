...
class COMMONCPP_API XDRDecoder
{
   ...
   */
  inline XDRDecoder& decode(bool &v) throw(IOException)
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(byte_t &v) throw(IOException)
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(char &v) throw(IOException)
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(int16_t &v) throw(IOException)
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(uint16_t &v) throw(IOException)
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(int32_t &v) throw(IOException)
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(uint32_t &v) throw(IOException)
  { _reader >> v; return(*this); }
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(int64_t &v) throw(IOException)
  { _reader >> v; return(*this); }
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(uint64_t &v) throw(IOException)
  { _reader >> v; return(*this); }
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(float &v) throw(IOException)
  { _reader >> v; return(*this); }
   ...
   * @throw IOException If an I/O error occcurs.
   */
  inline XDRDecoder& decode(double &v) throw(IOException)
  { _reader >> v; return(*this); }
