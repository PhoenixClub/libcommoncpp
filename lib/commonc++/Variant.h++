 ...
 * <i>wchar_t</i>, <i>int32_t</i>, <i>uint32_t</i>, <i>float</i>,
 * <i>double</i>, <i>int64_t</i>, <i>uint64_t</i>, String, WString, Blob,
...
class COMMONCPP_API Variant
{
  ...
  /** Variant value types. */
  enum Type { TypeNull = 0, TypeBool, TypeChar, TypeWChar, TypeInt, TypeUInt,
              TypeFloat, TypeDouble, TypeInt64, TypeUInt64, TypeString,
              TypeWString, TypeBlob, TypeOpaque, TypeList, TypeMap };
  ...
  /** Construct a new <i>wchar_t</i> variant.
   *
   * @param val The initial value.
   */
  explicit Variant(wchar_t val);
  ...
  /** Construct a new <i>String</i> variant.
   *
   * @param val The initial value.
   */
  explicit Variant(const String &val);

  /** Construct a new <i>WString</i> variant.
   *
   * @param val The initial value.
   */
  explicit Variant(const WString &val);
   ...
   * @param val The initial value.
   */
  explicit Variant(const wchar_t *val);

  /** Construct a new <i>Blob</i> variant.
   *
   * @param val The initial value.
   */
  ...
  /** Test if the Variant's value is a <i>wchar_t</i>. */
  inline bool isWChar() const
  { return(_type == TypeWChar); }
  ...
  /** Test if the Variant's value is a <i>String</i>. */
  inline bool isString() const
  { return(_type == TypeString); }

  /** Test if the Variant's value is a <i>WString</i>. */
  inline bool isWString() const
  { return(_type == TypeWString); }

  /** Test if the Variant's value is a <i>Blob</i>. */
  ...
  /** Return the Variant's value as a <i>wchar_t</i>, converting it if
   * necessary, or return <code>L'\\0'</code> if a conversion is
   * not possible or not meaningful.
   */
  ...
  /** Return the Variant's value as a <i>String</i>, converting it
   * if necessary, or return <code>String::null</code> if a
   * conversion is not possible or not meaningful.
   */
  String toString() const;

  /** Return the Variant's value as a <i>WString</i>, converting it
   * if necessary, or return <code>WString::null</code> if a
   * conversion is not possible or not meaningful.
   */
  WString toWString() const;

  /** Return the Variant's value as a <i>Blob</i>, converting it
  ...
  /** Cast operator. Equivalent to toWChar(). */
  ...
  /** Cast operator. Equivalent to toWString(). */
   ...
   */
  inline operator const void *() const throw()
  ...
  /** Assign a <code>wchar_t</code> value to the Variant. */
  ...
  inline Variant& operator=(const wchar_t *val)
  { return(operator=(WString(val))); }
