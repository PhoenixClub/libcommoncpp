...
template<typename T> ThreadLocal<T>::ThreadLocal() throw(SystemException)
{
...
template<typename T> ThreadLocal<T>::~ThreadLocal() throw()
{
#ifdef CCXX_OS_WINDOWS
...
template<typename T> T& ThreadLocal<T>::operator*() throw(NullPointerException)
{
  T *val = getValue();
...
template<typename T> T *ThreadLocal<T>::getValue() throw()
{
#ifdef CCXX_OS_WINDOWS
...
template<typename T> void ThreadLocal<T>::setValue(T *value) throw()
{
#ifdef CCXX_OS_WINDOWS
