...
class COMMONCPP_API MemoryStats : public SystemStats
{
  ...
  inline uint_t getPhysicalMemoryTotal() const throw()
  { return(_physTotal); }

  /** Get the amount of free physical memory, in bytes. */
  inline uint_t getPhysicalMemoryFree() const throw()
  { return(_physFree); }

  /** Get the amount of used physical memory, in bytes. */
  inline uint_t getPhysicalMemoryUsed() const throw()
  { return(_physUsed); }
   ...
   */
  inline uint_t getVirtualMemoryTotal() const throw()
  { return(_virtTotal); }

  /** Get the amount of free virtual memory, in bytes. */
  inline uint_t getVirtualMemoryFree() const throw()
  { return(_virtFree); }

  /** Get the amount of used virtual memory, in bytes. */
  inline uint_t getVirtualMemoryUsed() const throw()
  { return(_virtUsed); }
