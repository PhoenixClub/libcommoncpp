...
XMLElementConstIterator::XMLElementConstIterator(const XMLElement &elem,
...
const XMLElement & XMLElementConstIterator::next() throw(OutOfBoundsException)
{
  if(! _next)
...
void XMLElementConstIterator::remove() throw(UnsupportedOperationException)
{
